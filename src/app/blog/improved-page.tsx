      ...
      <header className="fixed top-0 w-full z-50 bg-black/80 backdrop-blur-sm px-6 py-4">
        <div className="flex justify-between items-center max-w-6xl mx-auto">
          ...
          <nav className="hidden md:flex space-x-8">
            <Link href="/enter#music" className="text-white hover:text-red-500 transition-colors">Music</Link>
            ...
            <Link href="/blog" className="text-red-500 transition-colors">Blog</Link>
